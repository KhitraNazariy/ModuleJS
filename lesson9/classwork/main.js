...
for (const item of coursesArray) {
    ...
    infoDiv.style.columnGap = '30px';

    let itemMonthDuration = document.createElement('h2');
    itemMonthDuration.innerText = item.monthDuration;

    let itemHourDuration = document.createElement('h2');
    ...
    infoDiv.append(itemMonthDuration, itemHourDuration);
    mainDiv.append(h1, infoDiv, ulList);
